      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL: "https://avatars.githubusercontent.com/u/110539009?v=4",
          })
            .then(() => {
  ...
  return (
    <div>
      ...
      <form
        ...
        className="absolute bg-black p-12 w-3/12 my-36 mx-auto left-0 right-0 text-white bg-opacity-80"
      >
